...
<div class="container" style="margin-top: 100px;">
  <h2 class="text-center" style="margin-bottom: 20px;">Manage Tourist Destination</h2>
  <table class="table table-border">
    <thead class="border-bottom font-weight-blod">
      ...
      <td>Longitude</td>
      <td>Description</td>
      <td colspan="2" align="center"><a href="add_destination.php" class="btn btn-outline-success"><i
...
foreach ($destinations as $destination): $i = $i + 1;?>
      <tr>
        ...
        <td class="align-middle"><a href="edit_destination.php?destinationid=<?=$destination[0]?>"
            class="btn btn-outline-primary">Edit
            Destination</a></td>
        <td class="align-middle">
          <form action="" method="POST">
            <input type="hidden" name="destinationid" value="<?=$destination[0]?>">
